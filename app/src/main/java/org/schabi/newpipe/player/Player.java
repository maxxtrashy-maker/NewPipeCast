...
public final class Player implements PlaybackListener, Listener, CastSessionCallback {
    ...
    private androidx.media3.common.Player currentPlayer;
    @NonNull
    ...
    public androidx.media3.common.Player getExoPlayer() {
    ...
    public void onCastSessionAvailable() {
        final androidx.media3.common.Player castPlayer =
    ...
    private void setCurrentPlayer(final androidx.media3.common.Player newPlayer) {
